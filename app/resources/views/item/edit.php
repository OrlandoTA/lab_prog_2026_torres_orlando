...
<form action="" class="formulario-alta" id = "formulario-alta" title="Formulario de edición de producto" autocomplete="off" name="formEditItems">
        ...
        <div class="fila">
            <div class="campo mitad">
                ...
                <input type="text" required disabled title="No editable" minlength="2" maxlength="100"
                    pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ0-9\s]+" id="nombre" name="nombre" value="">
            </div>       
            <div class="campo mitad">
